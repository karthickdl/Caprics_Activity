...
namespace CaterpillarSortingGame
{
    ...
    public class CaterpillarGameManager : MonoBehaviour
    {
        ...
        {
            DLearners.GameHandlerImmersiveGame.Instance.I_TotalPoints = I_CollectedPoints;
        ...
        public void THI_getPreviewData()
        {
            ...
            JSONNode parseJSON = JSON.Parse(DLearners.GameHandlerImmersiveGame.Instance.STR_previewJsonAPI);
